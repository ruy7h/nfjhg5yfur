...
sudo_users = {SUDO,1499701425,1593178008,1471425120,}   
...
var = 'شقوطه'
elseif tonumber(user_id) == tonumber(1471425120) then
var = 'التوب'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
...
local UserName = (data.username_ or "otlop12")
...
if text == 'حودا مطور السورس' and DevBOYKAW(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
{{text = 'مطور حودا ↗️️', url="t.me/MahmoudM2"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'شقوطه' and DevBOYKAW(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV SHA2OTA](t.me/Your_Nightmare0)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'شقوطه ↗️️', url="t.me/Your_Nightmare0"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = 'مالك السورس 💎', url="t.me/MahmoudM2"}}, 
...
if text == 'كلب نسخه الاحتياطيه' and DevBOYKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل صراحه' and Manager(msg) then   
if database:get(bot_id..'Cick:rkko'..msg.chat_id_) then
Text = ' ⊛ تم تفعيل نسبه صراحه'
database:del(bot_id..'Cick:rkko'..msg.chat_id_)  
else
Text = ' ⊛ بالتاكيد تم تفعيل صراحه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل صراحه' and Manager(msg) then  
if not database:get(bot_id..'Cick:rkko'..msg.chat_id_) then
database:set(bot_id..'Cick:rkko'..msg.chat_id_,true)  
Text = '\n ⊛ تم تعطيل صراحه'
else
Text = '\n ⊛ بالتاكيد تم تعطيل صراجه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if result.sender_user_id_ == tonumber(1593178008) then
send(msg.chat_id_, msg.id_, " ⊛ لا يمكنك حظر العضو \n")
return false 
end
if result.sender_user_id_ == tonumber(1499701425) then
send(msg.chat_id_, msg.id_, " ⊛ لا يمكنك حظر شقوطه\n")
return false 
end
if result.sender_user_id_ == tonumber(1496186391) then
send(msg.chat_id_, msg.id_, " ⊛ لا يمكنك حظر مطور السورس \n")
return false 
end
if result.sender_user_id_ == tonumber(1471425120) then
send(msg.chat_id_, msg.id_, " ⊛ لا يمكنك حظر مطور السورس \n")
return false 
end
...
send(msg.chat_id_, msg.id_, " ★ لا يمكنك حظر االعضو\n")
return false 
end
if result.id_ == tonumber(1471425120) then
send(msg.chat_id_, msg.id_, " ★ لا يمكنك حظر مطور السورس \n")
return false 
end
if result.id_ == tonumber(1496186391) then
send(msg.chat_id_, msg.id_, " ★ لا يمكنك حظر مطور السورس \n")
return false 
end
if result.id_ == tonumber(1499701425) then
send(msg.chat_id_, msg.id_, " ★ لا يمكنك حظر مطور السورس \n")
return false 
end
...
if text == ("جيب للمالك") or text == ("تاك للمالك") then
local list = database:smembers(bot_id..'CoSu'..msg.chat_id_)
...
if text == ("تاك للمنشئين الاساسين") or text == ("جيب المنشئين الاساسين") then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n ★ وينكم تعالو يريدوكم بكروب \n≪━━━━━━𝙳𝙴𝙱𝙾 ♫ ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("تاك للمنشئين") or text == ("جيب المنشئين") then
local list = database:smembers(bot_id..'Constructor'..msg.chat_id_)
t = "\n ★ وينكم تعالو يريدوكم بكروب \n≪━━━━━━𝙳𝙴𝙱𝙾 ♫ ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("تاك للمدراء") or text == ("جيب المدراء") then
local list = database:smembers(bot_id..'Manager'..msg.chat_id_)
t = "\n ★ وينكم تعالو يريدوكم بكروب \n≪━━━━━━𝙳𝙴𝙱𝙾 ♫ ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("تاك للادمنيه") or text == ("جيب الادمنيه") then
local list = database:smembers(bot_id..'Mod:User'..msg.chat_id_)
t = "\n ★ وينكم تعالو يريدوكم بكروب \n≪━━━━━━𝙳𝙴𝙱𝙾 ♫ ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("تاك للمميزين") or text == ("جيب المميزين") then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n ★ وينكم تعالو يريدوكم بكروب \n≪━━━━━━𝙳𝙴𝙱𝙾 ♫ ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("مسح الردود العامه") and DevBOYKAW(msg) then 
...
if text == ("الردود العامه") and DevBOYKAW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ★ قائمة الردود العامه \n≪━━━━━━𝙳𝙴𝙱𝙾 ♫ ━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد عام' and DevBOYKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد عام' and DevBOYKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = ' ونا كمان بعشقك💋 يا » {`'..(result.first_name_)..'`}'
else
first_name = ''
end   
if result.last_name_ then 
...
if text and text:match("^جيب (.*)$") then
local username = text:match("^جيب (.*)$") 
if not database:get(bot_id..'Seh:User'..msg.chat_id_) then
function start_function(extra, result, success)
...
send(msg.chat_id_, msg.id_,' ★ لا استطيع اجيب معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' ★ لا استطيع اجيب معرف بوتات') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'⚠| لا اسطيع جيب معرفات الجروبات') 
return false  
end
if result.id_ then
send(msg.chat_id_, msg.id_,' ★ تعال حبي يجيبونك بل كروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' ★ تم تعطيل امر جيب') 
end
return false
end
...
if text == 'تفعيل جيب' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' ★ تم تفعيل امر جيب'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' ★ بالتاكيد تم تفعيل امر جيب'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if text == 'تعطيل جيب' and Manager(msg) then  
if not database:get(bot_id..'Seh:User'..msg.chat_id_) then
database:set(bot_id..'Seh:User'..msg.chat_id_,true)  
Text = '\n ★ تم تعطيل امر جيب'
else
Text = '\n ★ بالتاكيد تم تعطيل امر جيب'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_, t..'ٴ★ٴ≪━━━━━━𝙳𝙴𝙱𝙾 ♫ ━━━━━━≫ٴ★○ٴ\n★ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/otlop12)➢ ')
end
-----------
...
if text == "بتحب دا" or text == "شنو رئيك بهذا" then
